...
$(document).ready(function(e) {
	...
	$("#left").click(function(){gd.Direction=2;});
	$("#right").click(function(){gd.Direction=3;});
	if ($('.media').size()>0){
		$('.media').media({
		 width:w,
		 height:h,
	...
	$(".tab1-title span").click(function(){
		$(".tab1-title span").removeClass('tab1-click');
		$(this).addClass('tab1-click');
	});
	$("#tab2").tabList({
			"menucon":"tab2-title",
			"con":"tab2-cont",
